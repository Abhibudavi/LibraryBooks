...
public class LibraryBookFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String msg, Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(msg)                            // required
                    .setSmallIcon(R.mipmap.book)   // required
